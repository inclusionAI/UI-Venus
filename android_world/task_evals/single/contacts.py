...
class NoiseResistContactsAddContactWithCall(contacts_validators.AddContact):
...
class ContactsAddContactCall(contacts_validators.AddContact):
  """Task for adding a new contact."""
