...
# Changes: add step_numb parameter in function step to support noiseresistance tasks in VenusBench.
...
def execute_adb_action(
  ...
  if action.action_type in ['click', 'double_tap', 'long_press']:
    ...
    print(f'env/actuation_qwen3.py: Invalid action type: {action.action_type}. (Not an exception.)')
