...
def download_app_data(file_name: str) -> str:
  ...
  # )
  cache_dir = file_utils.convert_to_posix_path("/home/zhengwen/.android/app_data")
  remote_url = (
  ...
  if not os.path.isfile(full_path):
    print("Downloading file_name %s to cache %s", file_name, cache_dir)
    ...
    print("File already %s exists in cache %s", file_name, cache_dir)
...
class KeePassLibre(AppSetup):
    """Class for setting up KeePass Libre app."""
    apk_names = ("com.kunzisoft.keepass.libre_139.apk",)
    app_name = "keepass libre"
...
class Pomodoro(AppSetup):
    """Class for setting up Pomodoro app."""
    apk_names = ("org.nsh07.pomodoro_10.apk",)
    app_name = "pomodoro"
...
class GymRoutines(AppSetup):
    """Class for setting up Gym Routines app."""
    apk_names = ("com.noahjutz.gymroutines_49.apk",)
    app_name = "gymroutines"
...
class LibreOfficeViewer(AppSetup):
    """Class for setting up LibreOffice Viewer app."""
    apk_names = ("libreoffice-viewer.apk",)
...
class Medilog(AppSetup):
    """Class for setting up Medilog app."""
    apk_names = ("com.zell_mbc.medilog_5499.apk",)
    app_name = "medilog"
...
class LibreOffice(AppSetup):
    """Class for setting up LibreOffice app."""
    apk_names = ("org.documentfoundation.libreoffice_89.apk",)
...
class FossifyGallery(AppSetup):
    """Class for setting up Fossify Gallery app."""
    apk_names = ("org.fossify.gallery_17.apk",)
    app_name = "fossify gallery"
...
class Flexify(AppSetup):
    """Class for setting up Flexify app."""
    apk_names = ("com.presley.flexify_2901.apk",)
    app_name = "flexify"
...
class NewPipe(AppSetup):
    """Class for setting up NewPipe app."""
    apk_names = ("org.schabi.newpipe_1005.apk",)
    app_name = "newpipe"
...
class AmazeFileManager(AppSetup):
    """Class for setting up Amaze File Manager app."""
    apk_names = ("com.amaze.filemanager_121.apk",)
    app_name = "amaze filemanager"
...
class Calcyou(AppSetup):
  """Class for setting up Calcyou app."""

  apk_names = ("net.youapps.calcyou_6.apk",)
  app_name = "calcyou app"
...
class Fitbook(AppSetup):
    """Class for setting up Fitbook app."""
    apk_names = ("fitbook.apk",)
    app_name = "fitbook"
...
class Zipxtract(AppSetup):
    """Class for setting up ZipXtract app."""
    apk_names = ("zipxtract.apk",)
    app_name = "zipxtract"
...
class Calculator(AppSetup):
  """Class for setting up Calculator app."""

  apk_names = ("Calculator_9.0.apk",)
  app_name = "calculator"
