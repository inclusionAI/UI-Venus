...
class UIVenusProcessor(BaseProcessor):
    """Generate prompts for the UI-Venus policy."""
    ...
    def process(self, state: Dict[str, Any], step: int, history: List[Dict[str, Any]]) -> Dict[str, Any]:
        """Process the current state and build model input.
        
        Args:
            state: State containing the screenshot and task.
            step: Current step number.
            history: Action history.
            
        Returns:
            A dictionary containing the screenshot and prompt.
        """
