...
@dataclass
class ModelConfig:
    """UI-Venus 1.5 Model Configuration"""
    model_path: str = "UI-Venus/UI-Venus-1.5-Pro"  # Default to UI-Venus 1.5
...
def main():
    ...
    parser.add_argument("--model_path", type=str, default='UI-Venus/UI-Venus-1.5-Pro')
    ...
    parser.add_argument("--prompt_type", type=str, default='mobile', choices=['web', 'mobile'],
                        help="Prompt type: 'web' for web tasks or 'mobile' for mobile tasks (default: mobile)")
    ...
    # 设置 prompt 类型
    from models.navigation.utils import get_user_prompt
    get_user_prompt(args.prompt_type)
    logger.info(f"Prompt type set to: {args.prompt_type}")
