...
class UI_Venus_Ground_72B:
    ...
    def load_model(self, model_name_or_path: str = None):
        ...
        # Apply image resolution limits
        self.processor.image_processor.max_pixels = self.config["max_pixels"]
        self.processor.image_processor.min_pixels = self.config["min_pixels"]
